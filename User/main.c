...
BUTTON_Handle mafAirFlowRateButton, engFuelRateButton, controlModVolButton, engineOilTempButton, fuelTankLvlButton, runTimeButton;
...
extern char* data;*/
//extern Command speedCommand, rpmCommand, inAirTempCommand, fuelPressureCommand, engineLoadCommand, engCollTempCommand;
//extern Command mafAirFlowRateCommand, throttlePosCommand, controlModVolCommand, engineOilTempCommand, fuelTankLvlCommand, runTimeCommand;
...
int main(void) {
  ...
  rpmButton = BUTTON_CreateEx(5, 30, 150, 30, 0, WM_CF_SHOW, 0, GUI_ID_BUTTON1);
	...
	Command mafAirFlowRateCommand = {.id=16,
													.name = "AirFlowRate",
													.request = "0110\r\n",
													.response = "",
													.responseType=1,
		...
		/* Check if button was pressed */
			switch(GUI_GetKey()){
				...
				case GUI_ID_BUTTON6:
					...
					break;
				case GUI_ID_BUTTON7:
					graphicInit(mafAirFlowRateCommand);	
					break;
				case GUI_ID_BUTTON8:
